    ...
    fsm.directive('fsmStickyHeader', ['$window',function($window){
        return {
            ...
            link: function(scope, element, attributes, control){
                ...
                var headerStartingWidth = 0;
                var headerStartingLeft = 0;
                ...
                function calculateSize() {
                  var val = {
                      ...
                      width: headerStartingWidth,
                      left: headerStartingLeft
                    };
                    clonedHeader.css(val);
                ...
                function createClone(){
                     ...
                     */
                    clonedHeader = header;
                    headerStartingWidth = header.outerWidth();
                    headerStartingLeft = header.offset().left;
